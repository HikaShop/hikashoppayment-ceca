...
?><div class="hikashop_ceca_end" id="hikashop_ceca_end">
	...
	<?php if($method->payment_params->debug){
		...
		//url de entorno de pruebas
		$urldestino="http://tpv.ceca.es:8000/cgi-bin/tpv";
	}
	else{
		//url de entorno de producci�n
	...
	<form id="hikashop_ceca_form" name="hikashop_ceca_form" action="<?php echo $urldestino;?>" method="post">
		...
		<?php
			...
			//siendo $Cifrado='SHA1', $Referencia='', y los dem�s datos los que nos proporciona la Ceca y nuestra web

			/*IDIOMAS

			1.- Espa�ol 2.- Catal�n 3.- Euskera 4.- Gallego 5.- Valenciano
			6.- Ingl�s 7.- Franc�s 8.- Alem�n 9.- Portugu�s 10.- Italiano
			11.- Sueco 12.- Dan�s 13.- Ruso 14.- Holand�s 15.- Noruego
